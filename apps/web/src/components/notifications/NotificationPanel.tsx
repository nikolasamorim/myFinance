  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className={cn('text-xs font-medium text-gray-900 leading-tight', !notification.is_read && 'font-semibold')}>
          {notification.title}
        </p>
    ...
    <div className="flex flex-col w-full">
      ...
      <div className="border-t border-gray-100 flex">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1.5 py-2.5 text-xs text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors border-r border-gray-100"
        >
          <Settings size={12} />
          Configurações
        </button>
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1.5 py-2.5 text-xs text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors"
        >
          <Maximize2 size={12} />
          Ver todas
        </button>
